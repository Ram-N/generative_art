...
function setup() {
    ...
    for (trans of [[xleft, yleft], [xRight, yRight]]) {
        cir += 1
        ...
        point(0, 0)
        gap = 0.1
        for (rep = 0; rep < connectionPoints.length - 25; rep++) {
    ...
    for (l = 0; l < numLines; l++) {
        line(startPts[0][l][0], startPts[0][l][1], startPts[1][l][0], startPts[1][l][1])
        line(endPts[0][l][0], endPts[0][l][1], endPts[1][l][0], endPts[1][l][1])
    }
