...
function setup() {
    ...
    currMin = mm[0]
    currMax = mm[1]
    rangeStep = (currMax - currMin) / params.numColors * 1.5
    ...
    for (x = cnv.xMargin; x < cnv.xMargin + cnv.width; x += 6) {
        for (y = cnv.yMargin; y < cnv.width + cnv.yMargin; y += 8) {
