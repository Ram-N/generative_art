...
function setup() {
    ...
    [0, 0, 0], [163, 147, 242], [0, 0, 0], [239, 6, 109], [0, 0, 0], [157, 67, 137], [0, 0, 0], [31, 163, 223],
    [0, 0, 0], [163, 147, 242], [0, 0, 0], [239, 6, 109], [0, 0, 0], [157, 67, 137], [0, 0, 0], [31, 163, 223],
    [0, 0, 0], [163, 147, 242], [0, 0, 0]]
    ...
    // PAINT IT
    for (x = cnv.xMargin; x < cnv.xMargin + cnv.width; x += 4) {
...
function complex_valued(x, y, verbose = false) {
    comp1 = y / 2 * cos(x) * sin(3 * x)
    comp2 = (3 * x - y) / 10 + tan(x)
    comp3 = cos(y) * sin(x)
