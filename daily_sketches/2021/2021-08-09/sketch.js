// Daily Sketch for 2021-08-09
// Ram Narasimhan

/*
Desc: Flow particles inside an irregular shape
...
class FlowPoint { // A point on the Grid
    ...
    update(containing_shape) { // update its location
        if (this.active) {
            ...
            this.x += dx
            this.y += dy
            if (out_of_bounds(this, containing_shape)) {
                this.active = false;
...
function out_of_bounds(fp, containing_shape) {
