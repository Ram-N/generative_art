...
function setup() {
    ...
    slider2 = createSlider(3, 20, 8, 1).parent(sliderPos);
...
function createOctagon(r, numSides) {
    vertices = [];
    mpts = []; //midpoints
    midspokes = [];
...
function render_octagrid(poly, transX, transY, sc) {
    push();
    noFill();
    stroke(222)
